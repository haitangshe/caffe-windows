#ifndef CAFFE_PARAMETRIC_LAYER_HPP_
#define CAFFE_PARAMETRIC_LAYER_HPP_
...
class ParametricLayer : public Layer<Dtype> {
 ...
 protected:
  ...
  /**
   * @brief Computes the error gradient w.r.t. the Parametric inputs.
   *
...
#endif  // CAFFE_PARAMETRIC_LAYER_HPP_
